...
export default {
  ...
  setup() {
    // const greeting = 'Hello World from Vue 3!';
...
.mono {
  font-family: "SF Mono", "Monaco", "Andale Mono", "Lucida Console", "Bitstream Vera Sans Mono", "Courier New", Courier, monospace!important;
