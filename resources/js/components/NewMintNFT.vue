<template>
  <div>
    ...
    <div style="max-width:620px;margin:0 auto;">
      ...
      <h1>Mint a Non-Fungible Token (NFT)</h1>

      <br><br>

      <span style="font-size:13px;">
        This is a generic ERC-721 non-fungible token (NFT) contract for the Ethereum blockchain, based on the <a href="https://openzeppelin.com/" target="_blank">OpenZeppelin</a> contract standards. The contract is deployed on the <a href="https://rinkeby.etherscan.io/address/0x2D4Fc4476B168057dc7589aA28e72f2af2017b5A" target="_blank">Rinkeby testnet</a>. Get some free Rinkeby ETH <a href="https://faucet.rinkeby.io/" target="_blank">here</a>. The contract source code is available on <a href="https://github.com/setinblock/nft-erc721-contract" target="_blank">GitHub</a>. To mint a new NFT is free, but you'll need to cover the network transaction fee, using your <a href="https://metamask.io/" target="_blank">MetaMask</a> wallet.
      </span>
      ...
      <span v-if="type == 'ipfs'">
        <span style="font-size:13px;">Upload your image to IPFS, Arweave, or similar. Create your metadata JSON file by adding token's name, link to token's image on IPFS, description, any attributes if needed. Upload this metadata file to IPFS, and provide its link for the NFT below.</span>
        <br>
        <br>
