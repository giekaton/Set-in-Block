  ...
  <div>
    ...
    <div style="max-width:620px;margin:0 auto;">
      ...
      <div style="text-align:left;font-size:13px;border:1px solid #cacaca;border-radius:5px;background-color:#f9f9f9;padding:20px;">
          ...
          <br><br>
          Optionally, upload the file to IPFS and include its link in the message. See this <a href="/msg/0x2dc3fcc6a0a23e88a82def9c07248731d98e7178a9fd4cee9ca72fa7e1a28774" target="_blank">example</a>.
          <br><br>
          For privacy reasons, every message is sent to a new randomly generated Ethereum address.
          <br><br>
